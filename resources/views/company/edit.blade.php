    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                @if ($company->id)
                <form method="post" action="{{ route('company.update', ['company' => $company->id]) }}" class="form-horizontal" enctype="multipart/form-data">
                    @method('PUT')
                    @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" type="title" name="title" id="title" placeholder="{{ __('Title') }}" value="{{ old('title', $company->title) }}" required />
                                            @if ($errors->has('title'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" type="description" name="description" id="description" placeholder="{{ __('Description') }}" value="{{ old('description', $company->description) }}" required />
                        ...
                        <div class="card-footer ml-auto mr-auto ">
                            <div class="row">
                                ...
                                <div class="col-4  text-right">
                                    <button type="submit" class="btn btn-primary">{{ $company->id ? __('Update') : __('Create') }}</button>
                                </div>
        ...
        <div class='row'>
            <div class="col-12">
                <div class='row images-container'>
                    ...
                    @if($company->images)
                    @foreach ($company->images as $single_image)
                    ...
                    <div class="col-3">
                        <div class="pd-1 fileinput text-center fileinput-exists" data-provides="fileinput">
                            ...
                            <div>
                                <a href="javascript:;" class="btn btn-danger btn-round fileinput-exists la-old-media" id='{{$single_image->id}}'>
