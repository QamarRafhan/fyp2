                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 text-right">
                                    <a href="{{ route('problem.create') }}" class="btn btn-sm btn-primary">Add Problem</a>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    ...
                                                    <a rel="tooltip" class="btn btn-success btn-link"
                                                        href="{{ route('problem.edit', ['problem' => $single->id]) }}"
                                                        data-original-title="" title="">
                                                        <i class="material-icons">edit</i>
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                    <a rel="tooltip" class="btn btn-success btn-link"
                                                        href="{{ route('problem.show', ['problem' => $single->id]) }}"
                                                        data-original-title="" title="">
                                                        <i class="material-icons">visibility</i>
                                                        <div class="ripple-container"></div>
                                                    </a>
                                                    <form action="{{ route('problem.destroy', ['problem' => $single->id]) }}"
                                                        method="post" class="d-inline-block">
                                                        <button type="submit" rel="tooltip"
                                                            class="btn btn-success btn-link" data-original-title=""
                                                            title="">
